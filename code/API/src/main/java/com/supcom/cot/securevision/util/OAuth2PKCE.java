...
import com.supcom.cot.securevision.controllers.Role;
...
public class OAuth2PKCE { //class containing useful methods needed to implement Oauth2 PKCE authentication with JWT
    ...
    static {
        ...
        char[] password = "password".toCharArray(); // get the password of the jwt keystore
        String alias = "jwt";
        PrivateKey pk = null;
        PublicKey pub = null;
        try {
            KeyStore ks = KeyStore.getInstance("JKS"); // the jwt keystore is in .jks format
            String configDir = "C:\\Users\\youss\\wildfly-34.0.1.Final\\standalone\\configuration";
